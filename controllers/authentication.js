...
exports.testing = (req, res, next) => {
  ...
  //   // Respond to request indication the user was created
  //   return res.json({ success: true, createStories: "successfuly!" });

  // });

  // Story.find({ title: "Rizwan Zaheer" }, (err, story) => {
  //   console.log('story!!!!!!!!');
  //   if (err) return next(err);
  //   if (story) {
  ...
  //     console.log(story);
  //     // stories = story;
  //     return res.send({ success: true, message: "users find!", story: story});
  //   }
  // });

  // Person.find({ _id: author_id }, (err, users) => {
  //   if (err) return next(err);
  //   var stories = [];
  //   if (users) {
  ...
  //     });
  //     console.log(stories);
  //     return res.send({ success: true, message: "users find!", users: users , stories: stories});
  //   }
  // });

  // Story.findOne({ title: name })
  //   .populate("author")
  ...
  // ]).exec(function(err, person) {
  //   if (err) return next(err);
  //   // person.findOne({ _id: author_id }).exec((err, findperson) => {
  //     // if (err) return next(err);
